...
> 3. ⬜ **"타겟 먼저" 모드** (Phase B·미착수) — 김짠부가 타겟 먼저 고정→그 타겟용 주제만 발굴 (target-persona 설계 (A)안).
