...
>
> **라이브 검증 대기(브라우저 수동):** structure-editing 드래그 UX · research-evidence-toggle 근거 토글(`script_review` 런 `8f95f3b4`) · 🔬 아래 체크리스트(copy-question-register 등 미완).
