...
function cfg(over: Partial<LlmConfig> = {}): LlmConfig {
  return { backend: "claude-p", fixtures: "off", softCapUsd: 7, hardCapUsd: 10, maxRework: 2, research: { maxClaims: 4, maxConcepts: 4, koreanOfficialDomains: [] }, search: { defaultTtlSeconds: 86_400, volatilityTtlSeconds: { static: 2_592_000, slow: 604_800, fast: 3_600 } }, ab: { decisiveMargin: 0.1, marginalMargin: 0.03 }, ...over };
}
