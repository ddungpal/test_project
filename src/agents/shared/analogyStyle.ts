...
export function appendAnalogyStyle(system: string, profile: ActiveAnalogyStyle | null): string {
  ...
  return [
    ...
    "⚠️ 배우는 것은 '기법'이지 '소재'가 아니다. 아래에 등장하는 구체 소재(예: 마을·물·토큰·바나나·수레 등",
    "레퍼런스의 특정 예시)는 기법을 설명하기 위한 예시일 뿐이다. 그 소재나 세계관을 절대 그대로 가져다 쓰지 마라.",
    "지금 이 주제에 딱 맞는, 완전히 새로운 비유를 직접 만들어라(기법만 빌리고 소재는 새로).",
