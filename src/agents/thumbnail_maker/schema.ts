    ...
    candidates: {
      ...
      items: {
        ...
        properties: {
          ...
          thumbnail_boxes: { type: "array", items: { type: "string", minLength: 1, maxLength: 6 }, minItems: 2, maxItems: 2 },
...
export const THUMBNAIL_MAKER_SYSTEM = [
  ...
  "- 글자수: 박스는 6자 이내 짧은 단어·구(임팩트), 메인문구는 14자 이내 한 호흡. 정보는 박스로 분리하고 메인은 후킹 한 방. 박스가 길어지면 단어로 쪼개라.",
  ...
  '- 예시(파킹통장): thumbnail_main = ["통장에 돈 묵히면 손해","파킹통장이 정답"], thumbnail_boxes = ["연4%이자","추천3곳"].',
  "",
  "원칙:",
