...
export const ANALOGY_EXTRACTION_SYSTEM = [
  ...
  "- ★★ techniques·do·banned 항목은 반드시 소재-중립으로 쓴다. 레퍼런스의 고유 소재·세계관(예: '바나나 마을', '물=돈',",
  "  '토큰', '수레' 같은 구체 명사)을 규칙 문장 안에 넣지 마라 — 그 소재는 다음 크리에이터가 그대로 베낄 위험이 있다.",
  "  '단일 재화로 가치를 치환한다'처럼 기법만 남기고, 구체 소재는 지워라. 예시가 꼭 필요하면 '(예: 일상재 하나)'처럼",
  "  일반명사로 익명화한다. 고유 세계관 이름은 금지.",
  "- techniques: 재사용 비유 기법(추상→구체 대입 방식 등). target_domains: 비유에 자주 쓰는 친숙한 영역의 '유형'(음식·몸·일상 사물 등 범주명. 특정 상표·특정 세계관 금지).",
