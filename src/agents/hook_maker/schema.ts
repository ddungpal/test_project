...
export const HOOK_MAKER_SYSTEM = [
  ...
  "- 입력에 reference_titles_external(주제 관련 고조회 유튜브 제목+조회수)이 있으면, 그 후킹 프레이밍·각도를 분석해 참고하라. 단 낚시·자극을 그대로 베끼지 말고, 김짠부의 직설·핵심 말투로 재창작하라. 조회수가 높다고 표현을 모방하지 않는다(말투 일관성 > 모방).",
  "- 한국어.",
].join("\n");
