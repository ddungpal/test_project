...
type StyleProfiles = { id: string; component_type: "title" | "thumbnail_copy" | "description" | "structure"; version: number | null; patterns: Json | null; status: ProfileStatus; created_at: string }; // migration 25: +structure(구다리 구성 패턴)
