...
type StyleProfiles = { id: string; component_type: "title" | "thumbnail_copy" | "description" | "structure" | "analogy_style"; version: number | null; patterns: Json | null; status: ProfileStatus; created_at: string }; // migration 25: +structure(구다리 구성 패턴); migration 33: +analogy_style(유이 비유 기법 프로필)
